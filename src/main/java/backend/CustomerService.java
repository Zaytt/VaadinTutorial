...
public class CustomerService {
    ...
    /**
     * @return a reference to an example facade for backend objects.
     */
    ...
    /**
     * @return all available backend objects.
     */
    ...
    /**
     * Finds all backend's that match given filter.
     *
     * @param stringFilter
     *            filter that returned objects should match or null/empty string
     *            if all objects should be returned.
     * @return list a backend objects
     */
    ...
    /**
     * Finds all backend's that match given filter and limits the resultset.
     *
     * @param stringFilter
     *            filter that returned objects should match or null/empty string
     *            if all objects should be returned.
    ...
    public synchronized void save(Customer entry) {
        if (entry == null) {
            LOGGER.log(Level.SEVERE,
                    "backend is null. Are you sure you have connected your form to the application as described in tutorial chapter 7?");
            return;
        }
        if (entry.getId() == null) {
            entry.setId(nextId++);
